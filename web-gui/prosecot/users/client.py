...
Generator (Build Your Own PROSEC)
...
# modules
from buildbot.core import util
from buildbot.core import security 
from buildbot.core import generators
...
def main(*args, **kwargs):
    ...
    if not kwargs:
        parser = argparse.ArgumentParser(
            prog='client.py',
            description="Generator (Build Your Own PROSEC)"
        )
        ...
        parser.add_argument('--gui',
                            action='store_true',
                            help='generate client controllable via web browser GUI at https://buildbot.com',
                            default=False)
